...
namespace sprint_2_draft {
    ...
    public partial class RegisterDataSet : global::System.Data.DataSet {
        ...
        public partial class RegisterDataTable : global::System.Data.TypedTableBase<RegisterRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public RegisterRow AddRegisterRow(string Fullname, string UserName, string Email, string Password) {
...
namespace sprint_2_draft.RegisterDataSetTableAdapters {
    ...
    public partial class RegisterTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Register` WHERE ((`ID` = ?) AND ((? = 1 AND `Fullname` IS NULL) OR (`Fullname` = ?)) AND ((? = 1 AND `UserName` IS NULL) OR (`UserName` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Register` (`Fullname`, `UserName`, `Email`, `Password`) VALUES (?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Register` SET `Fullname` = ?, `UserName` = ?, `Email` = ?, `Password` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Fullname` IS NULL) OR (`Fullname` = ?)) AND ((? = 1 AND `UserName` IS NULL) OR (`UserName` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::sprint_2_draft.Properties.Settings.Default.RegisterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Fullname, UserName, Email, [Password] FROM Register";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO `Register` (`Fullname`, `UserName`, `Email`, `Password`) VALUES (?, ?" +
                ", ?, ?)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Fullname", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Fullname", global::System.Data.DataRowVersion.Current, false, null));
        ...
        public virtual int Delete(int Original_ID, string Original_Fullname, string Original_UserName, string Original_Email, string Original_Password) {
        ...
        public virtual int Insert(string Fullname, string UserName, string Email, string Password) {
            if ((Fullname == null)) {
        ...
        public virtual int Update(string Fullname, string UserName, string Email, string Password, int Original_ID, string Original_Fullname, string Original_UserName, string Original_Email, string Original_Password) {
            if ((Fullname == null)) {
        ...
        public virtual int InsertQuery(string Fullname, string UserName, string Email, string Password) {
